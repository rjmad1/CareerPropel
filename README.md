...
See [docs/development/SETUP_GUIDE.md](_media/SETUP_GUIDE.md) for full setup including
...
**[docs/INDEX.md](_media/INDEX.md)** — complete documentation index.

Key documents:

| Document | Purpose |
|---|---|
| [Spec Workflow](_media/SPEC_WORKFLOW.md) | How features are built (spec → implement → deploy) |
| [Engineering Standards](_media/ENGINEERING_STANDARDS.md) | Coding and review standards |
| [AI Governance](_media/AI_GOVERNANCE.md) | LLM/prompt governance |
| [Threat Model](_media/THREAT_MODEL.md) | Security model and controls |
| [ADRs](_media/adr) | Architecture decision records |
| [Testing Strategy](_media/TESTING_STRATEGY.md) | Test pyramid and strategy |
| [Incident Response](_media/INCIDENT_RESPONSE.md) | Production incident runbook |
| [AI Dev Workflow](_media/AI_WORKFLOW.md) | Using Claude/Cursor with spec kit |

---

## Contributing

See [CONTRIBUTING.md](_media/CONTRIBUTING.md). This project uses a spec-driven engineering model:
...
**Full setup guide:** [docs/development/SETUP_GUIDE.md](_media/SETUP_GUIDE.md)
...
**Full API reference:** [docs/API_DESIGN.md](_media/API_DESIGN.md)
...
CareerPropel is conceptually inspired by the pioneering work of **Santiago Fernández de Valderrama** and his open-source project **[career-ops](https://github.com/santifer/career-ops)**. For a detailed list of all open-source libraries, credits, and code attributions, please refer to our official **[CONTRIBUTIONS.md](_media/CONTRIBUTIONS.md)** ledger.
...
- Architecture decisions: [docs/DESIGN_DECISIONS.md](_media/DESIGN_DECISIONS.md)
- Setup and development: [docs/development/SETUP_GUIDE.md](_media/SETUP_GUIDE.md)
- API reference: [docs/API_DESIGN.md](_media/API_DESIGN.md)
- System overview: [docs/ARCHITECTURE.md](_media/ARCHITECTURE.md)
