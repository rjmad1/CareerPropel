...
[CareerPropel API Reference](../globals.md) / env

# Variable: env

> `const` **env**: `object`

Defined in: [src/config/env.ts:85](https://github.com/rjmad1/CareerPropel/blob/1a201d07e0e7032a443e43e3eff7cdd09c8f364d/src/config/env.ts#L85)
