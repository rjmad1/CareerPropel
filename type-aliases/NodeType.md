...
[CareerPropel API Reference](../globals.md) / NodeType

# Type Alias: NodeType

> **NodeType** = `"skill"` \| `"achievement"` \| `"project"` \| `"company"`

Defined in: [src/types/knowledge-graph.ts:8](https://github.com/rjmad1/CareerPropel/blob/0d4fad15b81e49f3b873e8b104cec88970a01026/src/types/knowledge-graph.ts#L8)
