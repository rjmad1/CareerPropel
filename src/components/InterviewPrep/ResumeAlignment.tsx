...
export const ResumeAlignment: React.FC<ResumeAlignmentProps> = ({ prep }) => {
  ...
  return (
    <div data-cy="resume-alignment-tab" className="space-y-6 py-4">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200 rounded-lg p-5">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">Resume Fit Analysis</h3>
        ...
        <section className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {missingKeywords.map((keyword, idx) => (
              <span
                key={idx}
                className="bg-white border border-amber-300 text-amber-800 text-sm font-medium px-3 py-1.5 rounded-full"
          ...
          {skillGaps.map((gap, idx) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <div className="text-xs font-medium text-slate-600 mb-2">Required</div>
                ...
                <div>
                  <div className="text-xs font-medium text-emerald-600 mb-2">You Have</div>
                  <div className="space-y-1">
                ...
                <div>
                  <div className="text-xs font-medium text-amber-600 mb-2">Gap</div>
                  <div className="space-y-1">
                    {gap.gap.length > 0 ? (
                      gap.gap.map((g, gIdx) => (
                        <div
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-3">
          {tailoringTips.map((tip, idx) => (
            ...
            >
              <div className="font-semibold text-slate-900 mb-3">{tip.section}</div>
              <div className="space-y-2">
                <div>
                  <div className="text-xs font-medium text-slate-600 mb-1">Current:</div>
                  <div className="text-sm text-slate-700 bg-slate-50 rounded p-2 italic">
                    {tip.current}
                  </div>
                </div>
                <div>
                  <div className="text-xs font-medium text-emerald-700 mb-1">Suggested:</div>
                  <div className="text-sm text-emerald-900 bg-emerald-50 rounded p-2 italic">
                    {tip.suggested}
                  </div>
                </div>
                <div>
                  <div className="text-xs font-medium text-blue-700 mb-1">Example:</div>
                  <div className="text-sm text-blue-900 bg-blue-50 rounded p-2 font-mono">
                    "{tip.example}"
                  </div>
                </div>
              </div>
      ...
      <section className="bg-slate-50 border border-slate-200 rounded-lg p-4">
        <div className="text-sm font-semibold text-slate-900 mb-3">✏️ Resume Editing Checklist</div>
      ...
      {/* Final Tips */}
      <section className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4">
