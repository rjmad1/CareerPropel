...
export const TechnicalPrep: React.FC<TechnicalPrepProps> = ({ prep }) => {
  ...
  return (
    <div data-cy="technical-prep-tab" className="space-y-6 py-4">
      {/* Header */}
      <section className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg p-5">
        <div className="flex items-start gap-3">
          <Code2 className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-1" />
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-emerald-900 mb-2">Technical Interview Prep</h3>
            ...
            <div className="text-xs text-emerald-700 font-medium bg-white bg-opacity-50 px-3 py-2 rounded inline-block">
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
            ...
            <div className="text-xs text-green-700 mt-1">Warmup problems</div>
          </div>
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
            ...
            <div className="text-xs text-yellow-700 mt-1">Most interview questions</div>
          </div>
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
            ...
            <div className="text-xs text-red-700 mt-1">For senior positions</div>
          </div>
        </div>
      ...
      <section className="space-y-4">
        ...
        {commonTopics.map((categoryGroup, catIdx) => (
          <div key={catIdx} className="space-y-3" data-cy={`topic-category-${catIdx}`}>
            ...
            <div className="space-y-2">
              {categoryGroup.topics.map((topic, topicIdx) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-slate-50 hover:bg-slate-100 p-3 flex items-start justify-between transition-colors">
                      <div className="flex-1">
                        <div className="font-medium text-slate-900 mb-1">{topic.name}</div>
                        <div className="flex flex-wrap gap-1">
                          {topic.keyPoints.map((point, pIdx) => (
                            <span
                              key={pIdx}
                              className="text-xs bg-white border border-slate-300 text-slate-700 px-2 py-0.5 rounded"
                            >
                              {point}
                            </span>
                          ))}
      ...
      <section className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 space-y-3">
      ...
      <section className="bg-slate-50 border border-slate-200 rounded-lg p-4">
        <div className="text-sm font-semibold text-slate-900 mb-3">📚 Recommended Resources</div>
