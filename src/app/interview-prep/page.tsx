          ...
          <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {interviewJobs.map((job) => (
                    <PrepJobCard key={job.id} job={job} onPrepare={setSelectedJobId} highlight />
                  ))}
                </div>
              </div>
            )}
            {otherJobs.length > 0 && (
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {otherJobs.map((job) => (
                    <PrepJobCard key={job.id} job={job} onPrepare={setSelectedJobId} />
                  ))}
                </div>
              </div>
            )}
  ...
  return (
    <Card
      className={`p-4 hover:shadow-md transition-shadow duration-200 border ${
        highlight ? 'border-blue-200 bg-blue-50/20' : 'border-slate-200 bg-white'
      }`}
    >
