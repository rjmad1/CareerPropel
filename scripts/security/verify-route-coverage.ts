...
const TEMPORARY_EXCEPTIONS: TemporaryException[] = [
  ...
  },
  {
    ...
    reason: 'Retrieves agent execution history for the user.',
    owner: 'AI Orchestration Team',
    reviewCadence: 'Monthly',
    safeguards: 'Filtered by candidate session.',
    exitStrategy: 'Wrap in withAuth HOC.',
    expiration: '2026-07-31',
  },
  {
    route: 'api/agents/nba',
    reason: 'Autonomous agent decision engine.',
    owner: 'AI Orchestration Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual auth check.',
    exitStrategy: 'Wrap in withAuth HOC.',
    expiration: '2026-07-31',
  },
  {
    route: 'api/agents/plan',
    reason: 'Autonomous agent planner.',
    owner: 'AI Orchestration Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual auth check.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/analytics/behavioral',
    reason: 'User behavior tracking and analytics.',
  ...
  {
    route: 'api/analytics/compensation',
    reason: 'Benchmarking and offer analytics.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  },
  {
    ...
    reason: 'Aggregates dashboard data for candidates.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  },
  {
    ...
    reason: 'Exporting candidate analytical data.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  },
  {
    ...
    reason: 'Funnels and pipeline velocity forecasting.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/analytics/longitudinal',
    reason: 'Pipeline longitudinal status tracking.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/analytics/opportunity-quality',
    reason: 'Calculates job quality and fitness metrics.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  },
  {
    ...
    reason: 'Candidate pipeline health metrics.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  },
  {
    ...
    reason: 'Autonomous action recommendations.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/analytics/roi',
    reason: 'Job pipeline ROI calculations.',
    owner: 'Analytics Team',
    reviewCadence: 'Monthly',
    safeguards: 'Manual session context verify.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/approvals',
    reason: 'Lists workflow pending approvals.',
    owner: 'Orchestration Team',
    reviewCadence: 'Monthly',
    safeguards: 'Candidate boundary checks.',
    exitStrategy: 'Wrap in withAuth HOC.',
    expiration: '2026-07-31',
  },
  {
    route: 'api/approvals/[id]/decide',
    reason: 'Records approval decision.',
    owner: 'Orchestration Team',
    reviewCadence: 'Monthly',
    safeguards: 'Candidate boundary checks.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/contacts',
    reason: 'Lists and creates outreach contacts.',
    owner: 'Core App Team',
    reviewCadence: 'Monthly',
    safeguards: 'Filtered by candidate session.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  },
  {
    ...
    reason: 'Manages candidate contacts.',
    owner: 'Core App Team',
    reviewCadence: 'Monthly',
    safeguards: 'Filtered by candidate session.',
    exitStrategy: 'Wrap in withAuth HOC.',
  ...
  {
    route: 'api/jobs',
    reason: 'Job search history and active operations tracking.',
    owner: 'Core App Team',
    reviewCadence: 'Bi-monthly',
    safeguards: 'Session authorization checking.',
    exitStrategy: 'Refactor to leverage withAuth.',
    expiration: '2026-07-31',
  },
  {
    route: 'api/ops/alerts',
    reason: 'Operational system health alerts and notifications.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Internal secure environment constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
    expiration: '2026-07-31',
  },
  {
    route: 'api/ops/cost',
    reason: 'Operational resource cost metrics profiling.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Internal secure environment constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
  ...
  {
    route: 'api/ops/dlq',
    reason: 'Dead Letter Queue monitoring dashboard.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Admin permission constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
    expiration: '2026-07-31',
  },
  {
    route: 'api/ops/dlq/replay',
    reason: 'Dead Letter Queue retry executor.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Admin permission constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
  ...
  {
    route: 'api/ops/executions',
    reason: 'Platform task execution operational monitoring.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Internal secure environment constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
  ...
  },
  {
    ...
    reason: 'Observability platform runtime metrics.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Internal secure environment constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
  ...
  {
    route: 'api/ops/providers',
    reason: 'LLM API provider latency and failure metrics.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Internal secure environment constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
  ...
  {
    route: 'api/ops/queue',
    reason: 'Background queue status tracking.',
    owner: 'DevOps Lead',
    reviewCadence: 'Monthly',
    safeguards: 'Internal secure environment constraints.',
    exitStrategy: 'Refactor to leverage withAuth.',
